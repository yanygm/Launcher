...
public abstract class IntKeyframeData<TKeyframe> : IIntKeyframeData, IKeyframeData<int>, IList<TKeyframe>, ICollection<TKeyframe>, IEnumerable<TKeyframe>, IEnumerable where TKeyframe : IKeyframe<int>
{
    public class Enumerator : IEnumerator<IKeyframe<int>>, IEnumerator, IDisposable
    {
    ...
    public int GetValue(float time)
    {
        ...
        IKeyframe<int> keyframe = this[i];
        object obj;
        if (i + 1 < Count)
        {
            IKeyframe<int> keyframe2 = this[i + 1];
            obj = keyframe2;
        }
        else
        {
        ...
        IKeyframe<int> keyframe3 = (IKeyframe<int>)obj;
